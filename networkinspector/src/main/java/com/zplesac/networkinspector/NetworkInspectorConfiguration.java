 ...
 * Configuration class for NetworkInspector instance. Use this to customize the library behaviour.
 */
public class NetworkInspectorConfiguration {
    ...
    private ConnectivityInspectorStrenght minimumSignalStrength;
    ...
    private NetworkInspectorConfiguration(Builder builder) {
    ...
    public ConnectivityInspectorStrenght getMinimumSignalStrength() {
    ...
    public static class Builder {
         ...
         * Default is set to NetworkInspectorStrenght.POOR.
         */
        private ConnectivityInspectorStrenght minimumlSignalStrength = ConnectivityInspectorStrenght.POOR;
        ...
        public Builder setMinimumSignalStrength(ConnectivityInspectorStrenght connectivityInspectorStrenght) {
            this.minimumlSignalStrength = connectivityInspectorStrenght;
            return this;
        }
        ...
        public NetworkInspectorConfiguration build() {
            return new NetworkInspectorConfiguration(this);
        }
    }
}
